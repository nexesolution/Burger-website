...
export const INITIAL_INVENTORY: InventoryItem[] = [
  {
    ...
    unitCost: 350,
    supplier: 'Prime Halal Butchery Karachi',
    lastUpdated: '2026-08-07'
  },
  {
    id: 'inv-2',
    sku: 'RAW-CHICKEN-02',
    name: 'Buttermilk Chicken Breasts',
    category: 'Meat & Poultry',
    currentStock: 180,
    unit: 'pcs',
    lowStockThreshold: 40,
    unitCost: 220,
    supplier: 'K&N Fresh Poultry',
    lastUpdated: '2026-08-07'
  },
  {
    id: 'inv-3',
  ...
  },
  {
    id: 'inv-4',
    sku: 'RAW-CHEDDAR-04',
    name: 'Aged Wisconsin Cheddar Slices',
    category: 'Dairy',
    currentStock: 500,
    unit: 'slices',
    lowStockThreshold: 80,
    unitCost: 45,
    supplier: 'Dairy Land Pakistan',
    lastUpdated: '2026-08-07'
  },
  {
    id: 'inv-5',
    sku: 'RAW-FRIES-05',
    name: 'Cut Shoestring Potato Fries',
    category: 'Frozen Foods',
    currentStock: 18,
    unit: 'kg',
    lowStockThreshold: 25,
    unitCost: 480,
    supplier: 'Opal Frozen Foods Lahore',
    lastUpdated: '2026-08-07'
  },
  {
    id: 'inv-6',
    sku: 'RAW-SAUCE-06',
    name: 'BUZZ Secret Recipe Sauce',
    category: 'Condiments',
    currentStock: 45,
    unit: 'liters',
    lowStockThreshold: 10,
...
export const INITIAL_FBR_CONFIG: FBRConfig = {
  ntn: '4984512-7',
  posId: 'POS-KHI-001',
  apiUrl: 'https://iris.fbr.gov.pk/api/v1/pos/invoice',
  environment: 'Sandbox',
  token: 'fbr_pk_demo_token_sec_893471982',
  isConnected: true
};
